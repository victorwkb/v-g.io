              ...
              <AnimatePresence>
                {open && (
                  <Listbox.Options
                    ...
                    className="max-h-70 w-42 absolute right-0 mt-2 origin-top-right overflow-auto rounded-xl bg-white p-2 text-base capitalize shadow-lg focus:outline-none dark:bg-black sm:text-sm"
                  >
                    {themes.map((theme) => (
                      <Listbox.Option
                        key={theme}
