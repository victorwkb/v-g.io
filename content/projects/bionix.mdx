...
<Image
  src="/projects/bionix/bionix-logo.png"
  alt="BioNix Logo"
  width={1534}
  height={400}
  contained
...
<Image
  src="/projects/bionix/qc-pipe.png"
  alt="QC-Pipe"
  width={1000}
  height={500}
  caption="Original QC Pipeline developed by Papenfuss Lab."
  contained
  size="lg"
/>
...
As the first intern for the BioNix project at Papenfuss Lab, I was able to reduce the steep learning curve for future interns by providing detailed [documentation and guide](https://github.com/victorwkb/BioNix-Doc) with code examples. My work has helped them understand the BioNix's architecture and important bits of Nix to start contributing without going through Nix's thorough manual. At the time of writing, this [repository](https://github.com/WEHI-ResearchComputing/BioNix-GettingStarted/wiki) contains the latest documentation and work contributed by a few cohort of interns.
